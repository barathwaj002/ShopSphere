...
function Landing() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#050816] text-white">
      ...
      <section className="relative z-20 mx-auto flex max-w-7xl flex-col items-center justify-between gap-20 px-8 pt-20 lg:flex-row">
        ...
        >
          ...
          <p className="mt-8 text-lg leading-8 text-slate-300">
            ...
            ShopSphere combines premium shopping, secure payments,
            lightning-fast delivery and an elegant user experience
      ...
      <footer className="relative z-20 mt-24 border-t border-white/10 py-8 text-center text-slate-500">

        © {new Date().getFullYear()} ShopSphere.
        Crafted with ❤️ for modern online shopping.
